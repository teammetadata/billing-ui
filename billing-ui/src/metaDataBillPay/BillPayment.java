...
//	}
	...
	private void initialize() {
		...
		Database_SQLQueries d=new Database_SQLQueries();
		String [] s=d.UserConfInfo("hh");
		...
		Database_SQLQueries b=new Database_SQLQueries();
		String [] l=d.UserConfInfo("hh");
		lblNewLabel.setText(s[1]);
		...
		Database_SQLQueries c=new Database_SQLQueries();
		String [] o=d.UserConfInfo("15629222");
		lblNewLabel.setText(s[2]);
		...
		Database_SQLQueries y=new Database_SQLQueries();
		String [] m=d.UserConfInfo("15629222");
		lblNewLabel.setText(s[2]);
